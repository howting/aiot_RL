...
def save_reconstructed_images(recon_images, epoch):
    save_image(recon_images.cpu(), f"training-images/0108VAE_road/reconstructed{epoch}.jpg")


def save_noisy_images(recon_images, epoch):
    save_image(recon_images.cpu(), f"training-images/0108VAE_road/noisy{epoch}.jpg")


def save_raw_images(recon_images, epoch):
    save_image(recon_images.cpu(), f"training-images/0108VAE_road/raw{epoch}.jpg")
...
def save_single_reconstructed_images(recon_images, epoch):
    save_image(recon_images.cpu(), f"training-images/0108VAE_road/vae_single{epoch+1}.jpg")
...
dataloader = DataLoader("images/road", 64)
ae_id = int(time.time())
ae_id = "0108VAE_road"
